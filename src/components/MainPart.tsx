            ...
            <div className="w-1/2">
                <form className="space-y-4">
                    <div>
                        ...
                        <input type="text" id="name" placeholder="Blood" className="w-full border border-purple-500 rounded p-2" required/>
                    </div>
                    <div>
                        <label htmlFor="email" className="block text-sm font-semibold">Your mail</label>
                        <input type="email" id="email" placeholder="mary@mail.ru" className="w-full border border-purple-500 rounded p-2"/>
                        <p className="text-xs text-gray-500 mt-1">We will send you the final date and time of the meeting after the end of the survey</p>
                    </div>
